---
date: '2025-11-22T18:22:50-05:00'
...
{{< hextra/hero-subtitle >}}
  AI-Powered Real-Time Content Filtering for Child Safety
{{< /hextra/hero-subtitle >}}
</div>

<div class="hx:mb-6 hx:mt-12">
{{< hextra/hero-button text="Get Started" link="https://chromewebstore.google.com/detail/aaepaimdjblkleipgbkgmokokdmdhpob" >}}
</div>
...
{{< hextra/hero-section >}}The Problem{{< /hextra/hero-section >}}

{{< callout type="info" >}}
Aegis Explorer helps create a safer environment by offering fast and transparent filtering that supports responsible internet use.
{{< /callout >}}
...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card 
      title="≈50% Cyberbullying" 
      subtitle="Nearly half of kids experience cyberbullying." 
...
{{< hextra/hero-section >}}Why Aegis Explorer{{< /hextra/hero-section >}}
